...
import yargs from "../Node_JS_Packages/node_modules/yargs";
import { hideBin } from "../Node_JS_Packages/node_modules/yargs/helpers";
...
argvParser.command({
    ...
    handler(argv) {
        log(argv.number1,"+",argv.number2,"=",argv.number1 + argv.number2);
        return;
    }
});
...
argvParser.command({
    ...
    handler(argv) {
        log(argv.number1,"-",argv.number2,"=",argv.number1 - argv.number2);
        log(argv.number2,"-",argv.number1,"=",argv.number2 - argv.number1);
        return;
    }
});
...
argvParser.command({
    ...
    handler(argv) {
        log(argv.number1,"x",argv.number2,"=",argv.number1 * argv.number2);
        return;
    }
});
